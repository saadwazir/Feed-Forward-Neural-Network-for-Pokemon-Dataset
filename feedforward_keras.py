...
def run_network(data=None, model=None, epochs=100, batch=32):
    try:
        ...
        lr_reducer = ReduceLROnPlateau( factor=np.sqrt(0.1),cooldown=0, patience=1, verbose=1,  mode='max',  min_lr=0.5e-6)
        ...
        model.fit(X_train, y_train, epochs=epochs, batch_size=batch,
                  ...
                  ,validation_split=None, validation_data=[X_test, y_test]
                  , verbose=1)
